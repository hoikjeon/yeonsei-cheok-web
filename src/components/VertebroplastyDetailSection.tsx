...
function ProcedureCards({
  ...
  return (
    <div>
      <p className="mb-3 text-[12px] font-semibold text-ink-sub md:hidden">
        옆으로 밀어 네 단계를 확인하세요.
      </p>
      <ol
        aria-label={label}
          ...
          >
            ...
            <div className="p-4 sm:p-5">
              <div className="flex items-center gap-3">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary font-montserrat text-[12px] font-bold text-white">
                  {item.number}
                </span>
    ...
    >
          ...
          <div className="relative md:min-h-[560px] xl:min-h-[620px]">
            <div className="relative z-10 pb-7 md:absolute md:inset-y-0 md:left-0 md:flex md:w-[57%] md:items-center md:px-10 md:pb-0 lg:px-14 xl:px-16">
              <div className="max-w-[660px]">
                <h2 className="break-keep text-h2 tracking-tight text-ink md:text-white">
                  <span className="inline-block">주저앉은 척추뼈의 통증,</span>{" "}
                  <span className="inline-block">필요한 경우에만</span>{" "}
                  <span className="inline-block">정밀하게 보강합니다</span>
                </h2>
                <p className="mt-5 max-w-[600px] break-keep text-body-lg text-ink-sub md:mt-7 md:text-white/85">
            ...
            <p className="mt-2 px-1 break-keep text-[12px] font-semibold leading-[1.6] text-ink-sub md:absolute md:bottom-5 md:right-6 md:z-20 md:mt-0 md:rounded-full md:bg-black/45 md:px-3 md:py-1.5 md:text-white/85 md:backdrop-blur-sm">
      ...
      <ScrollReveal variant="soft-rise" amount={0.08}>
        <section id="vertebroplasty-candidates">
          ...
          <div className="mt-8 rounded-[1.25rem] border border-primary/15 bg-[#F3F6FC] p-5 sm:mt-10 sm:rounded-[1.5rem] sm:p-7 md:p-9">
            <h4 className="break-keep text-h4 text-ink">
      ...
      <ScrollReveal variant="soft-rise" amount={0.08}>
        <section id="vertebroplasty-process">
          <div className="max-w-4xl">
            <p className="font-montserrat text-[11px] font-bold uppercase tracking-[0.18em] text-primary">
              Percutaneous Vertebroplasty
            </p>
            <h3 className="mt-3 break-keep text-h2 tracking-tight text-ink">
              경피적 척추성형술 과정
            </h3>
            <p className="mt-5 max-w-3xl break-keep text-body-lg text-ink-sub">
              ...
              <ul className="mt-7 space-y-4">
                {evaluateFirst.map((item) => (
                  <li key={item} className="flex items-start gap-3">
                    ...
                    <p className="break-keep text-body text-white/85">
                      {item}
                    </p>
                  </li>
                ))}

...
const mobileDiseaseMarkers = [
  {
    id: 'rotator-cuff',
    title: '회전근개 파열',
    point: { left: '27%', top: '55.5%' },
  },
  {
    id: 'frozen-shoulder',
    title: '오십견',
    point: { left: '73%', top: '52%' },
  },
  {
    id: 'calcific-tendinitis',
    title: '석회성건염',
    point: { left: '76%', top: '64%' },
  },
] as const satisfies ReadonlyArray<MobileDiseaseMapMarker<ShoulderDiseaseId>>;
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <ScrollReveal variant="image" amount={0.18} className="mt-12 md:mt-20">
          <div className="relative overflow-hidden rounded-[1.25rem] border border-slate-100 bg-white px-5 py-6 shadow-[0_24px_70px_rgba(15,29,54,0.07)] sm:px-7 sm:py-8 lg:min-h-[620px] lg:rounded-[28px] lg:px-14 lg:py-14">
            ...
            <MobileDiseaseMap
              imageSrc={`${ASSET_ROOT}/shoulder-disease-map-white.png`}
              imageAlt="회전근개 파열, 오십견, 석회성건염 부위를 선택할 수 있는 어깨 질환 의료 일러스트"

...
import { MAX_IMAGE_COUNT, validateUploadFiles } from '@/lib/imageUploadRules';
    ...
    <div className="mx-auto w-full max-w-6xl space-y-5 p-5 md:p-8">
      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        <fieldset disabled={locked} className="space-y-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm md:p-8">
          <div className="flex flex-wrap items-center justify-between gap-3"><h2 className="flex items-center gap-2 font-bold"><FileImage size={18} /> 첨부·대표 이미지</h2><span className="text-xs text-slate-500">본문 포함 {allImages.length}/10개 · 파일당 10MB</span></div>

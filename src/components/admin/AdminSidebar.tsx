...
import { LogOut, Calendar, MessageSquare, Settings, LayoutDashboard } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-[#172b4d] text-white hidden md:flex flex-col shadow-xl flex-shrink-0">
      <div className="p-8 pb-4">
        ...
        <p className="text-blue-300 text-[10px] mt-1 font-bold uppercase tracking-wider opacity-70">Hospital Admin System</p>
      </div>
      ...
      <div className="p-4 border-t border-white/5">
        <form action={adminLogout}>
          <button type="submit" className="w-full flex items-center gap-2 justify-center py-3.5 bg-white/5 hover:bg-red-500/10 text-slate-400 hover:text-red-400 rounded-xl transition-all text-[13px] font-bold">
            <LogOut size={16} /> 로그아웃
          </button>
        </form>
      </div>

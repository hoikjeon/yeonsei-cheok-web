...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-6 relative">
      <Link href="/" className="absolute top-8 left-8 text-ink-muted font-bold hover:text-primary transition-colors text-sm flex items-center gap-2">
        &larr; 홈페이지로 돌아가기
      </Link>
      ...
      <div className="w-full max-w-md bg-white rounded-[2rem] shadow-premium p-10 mt-10">
        <div className="text-center mb-10">
          ...
          <p className="text-ink-muted text-sm mt-2 font-medium">연세척병원 통합 관리 시스템</p>
        </div>

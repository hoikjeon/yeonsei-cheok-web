          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                <th className="px-8 py-5 text-xs font-black text-ink-muted font-montserrat uppercase tracking-wider">상태</th>
                <th className="px-8 py-5 text-xs font-black text-ink-muted font-montserrat uppercase tracking-wider">신청일시</th>
                <th className="px-8 py-5 text-xs font-black text-ink-muted font-montserrat uppercase tracking-wider">환자정보</th>
                <th className="px-8 py-5 text-xs font-black text-ink-muted font-montserrat uppercase tracking-wider">진료내역</th>
                <th className="px-8 py-5 text-xs font-black text-ink-muted font-montserrat uppercase tracking-wider">희망일정</th>
                <th className="px-8 py-5 text-xs font-black text-ink-muted font-montserrat uppercase tracking-wider text-right">작업</th>
              </tr>
            </thead>

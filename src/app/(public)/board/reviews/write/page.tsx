  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-[96px]">
      <div className="max-w-[1000px] mx-auto px-6 py-16">
        ...
        {/* Back navigation */}
        <Link href="/board/reviews" className="inline-flex items-center gap-2 text-ink font-black text-[24px] tracking-tight hover:text-primary transition-colors mb-12">
        ...
        >
          ...
          <div className="mb-12 text-center md:text-left">
            ...
            <p className="text-ink-muted text-[16px] md:text-[18px] font-bold tracking-tight leading-relaxed">
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-4 relative">
              ...
              <div className="relative">
                <button 
                  ...
                  className="w-full text-left px-6 py-5 rounded-[1.25rem] bg-slate-50 border-2 border-slate-100 font-bold text-ink-sub text-[17px] flex justify-between items-center outline-none focus:border-primary transition-all active:scale-[0.99]"
                >
                  {category}
            ...
            <div className="space-y-4">
              ...
              <input 
                ...
                className="w-full px-6 py-5 rounded-[1.25rem] border-2 border-slate-100 bg-white font-bold text-ink text-[17px] placeholder:text-ink-muted outline-none focus:border-primary focus:bg-primary/5 transition-all tracking-tight"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                />
                <div className="w-20 h-20 bg-white shadow-sm rounded-full flex items-center justify-center text-ink-muted group-hover:text-primary group-hover:scale-110 transition-all mb-4">
                  <UploadCloud size={32} strokeWidth={2.5} />
                </div>
                <p className="font-black text-ink text-[20px] mb-2 tracking-tight group-hover:text-primary transition-colors">
            ...
            <div className="space-y-4">
              ...
              <textarea 
                ...
                className="w-full px-8 py-7 rounded-[1.5rem] border-2 border-slate-100 bg-white font-bold text-ink text-[17px] leading-[1.8] placeholder:text-slate-300 outline-none focus:border-primary focus:bg-primary/5 transition-all tracking-tight resize-none"
              />
            </div>

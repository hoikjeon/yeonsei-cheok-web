  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-[96px]">
      <div className="max-w-[1000px] mx-auto px-6 py-16">
        ...
        <Link href="/news/academic" className="inline-flex items-center gap-2 text-ink font-black text-[24px] tracking-tight hover:text-primary transition-colors mb-12">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-[2rem] p-10 md:p-14 shadow-sm border border-slate-100">
          <h2 className="text-[32px] md:text-[40px] font-black text-ink tracking-tighter mb-8 flex items-center gap-4">
            <GraduationCap size={40} className="text-primary" /> 연구 활동 기록
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-4">
              <label className="block text-[16px] font-black text-ink tracking-tight">연구 내용 및 상세 소식 <span className="text-red-500">*</span></label>
            ...
            <div className="space-y-4">
              <label className="block text-[16px] font-black text-ink tracking-tight">관련 이미지 (논문 표지, 학회 사진 등)</label>
            ...
            <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row gap-4">
              <Link href="/news/academic" className="flex-[1] flex justify-center items-center py-5 rounded-[1.25rem] bg-slate-100 font-black text-ink-muted">취소</Link>

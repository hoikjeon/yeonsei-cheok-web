  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-0 md:pt-[96px]">
      <div className="mx-auto max-w-[1000px] px-4 py-10 sm:px-6 sm:py-14 md:py-16">
        ...
        <Link href="/news/academic" className="mb-8 inline-flex items-center gap-2 text-[20px] font-black tracking-tight text-ink transition-colors hover:text-primary sm:mb-12 sm:text-[24px]">

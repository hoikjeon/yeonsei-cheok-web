    ...
    <main className="min-h-screen bg-white pt-[96px]">
      ...
      <div className="max-w-[1000px] mx-auto px-6 py-16 md:py-24">
        ...
        <div className="flex justify-center items-center gap-4">
          <Link href="/news/academic" className="flex items-center gap-2 px-10 py-5 bg-slate-100 hover:bg-slate-200 text-slate-600 font-black rounded-[1.25rem] transition-all active:scale-95 text-[17px]">

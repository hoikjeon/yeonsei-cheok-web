    ...
    <main className="min-h-screen bg-white pt-[96px]">
      ...
      <div className="max-w-[1000px] mx-auto px-6 py-16 md:py-24">
        ...
        <div className="mb-12 border-b border-slate-100 pb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/5 border border-primary/10 rounded-full text-primary text-[13px] font-black tracking-tight mb-6 uppercase">
            <Newspaper size={12} />
            Media News
          </div>
          ...
          <div className="mb-20 flex flex-col items-center gap-10">
            {item.image_urls.map((url: string, index: number) => (
              ...
              >
                <img 
                  src={url} 
                  alt={`${item.title} 보도 자료 이미지 ${index + 1}`} 
        ...
        <div className="flex justify-center items-center gap-4">
          ...
          {item.source_url && (
             <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 px-10 py-5 bg-primary text-white font-black rounded-[1.25rem] transition-all active:scale-95 text-[17px] shadow-blue-glow"
             >

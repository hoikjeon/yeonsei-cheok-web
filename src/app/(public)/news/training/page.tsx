        ...
        <div className="mx-auto min-h-0 max-w-7xl border-x border-slate-50 px-4 py-14 sm:px-6 sm:py-16 md:min-h-[800px] lg:px-10 lg:py-24">
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="flex justify-center pt-10 border-t border-slate-100">
              <Link href="/news/training/write" className="inline-flex w-full items-center justify-center gap-3 rounded-xl bg-navy-950 px-5 py-4 text-[16px] font-bold text-white shadow-lg shadow-navy-950/20 transition-all hover:bg-primary sm:w-auto sm:rounded-[1.25rem] sm:px-12 sm:py-5 sm:text-[18px]">

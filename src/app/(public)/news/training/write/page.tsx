  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-0 md:pt-[96px]">
      <div className="mx-auto max-w-[1000px] px-4 py-10 sm:px-6 sm:py-14 md:py-16">
        ...
        <Link href="/news/training" className="mb-8 inline-flex items-center gap-2 text-h4 tracking-tight text-ink transition-colors hover:text-primary sm:mb-12">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm sm:p-6 md:rounded-[2rem] md:p-14">
          ...
          <form onSubmit={handleSubmit} className="space-y-7 sm:space-y-10">
            ...
            <div className="space-y-4">
              <label className="block text-[16px] font-bold text-ink tracking-tight">활동 내용 및 상세 정보 <span className="text-red-500">*</span></label>
            ...
            <div className="space-y-4">
              <label className="block text-[16px] font-bold text-ink tracking-tight">첨부 이미지 (교육 현장 사진 등)</label>
            ...
            <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row gap-4">
              <Link href="/news/training" className="flex-[1] flex justify-center items-center py-5 rounded-[1.25rem] bg-slate-100 font-bold text-ink-muted">취소</Link>
